...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <div class="container-fluid">
    ...
    include 'newsletter-delete.php';

    $q = "SELECT COUNT(email) FROM NEWSLETTER";
    $req = $bdd->query($q);
    $req->execute();
    $result = $req->fetch(PDO::FETCH_ASSOC); ?>

      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ld_item">
        <h2 class="ld_itema">Newsletter (<?php echo $result['COUNT(email)'] ?>)</h2>

        <div class="mb-3 d-flex">
            <a href="send_email.php" class="btn btn-light d-flex align-items-center me-3" style="font-weight:600; font-size:1.2em;">Envoyer une new<i style="font-size:1.8em" class="uil uil-fast-mail ms-2"></i></a>
        </div>
                ...
                if (!isset($_GET['type']) || $_GET['type'] == 'delete') {
                  echo '<th scope="col" class="d-flex justify-content-center">
                          <div class=" hover-effect d-flex align-items-center">
                            ...
                            <a class="add-cta ld_itema" href="newsletter?type=create">Ajouter un utilisateur</a>     
                          </div>
                        </th>';
                } else {
