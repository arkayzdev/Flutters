...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  ...
  <div class="container-fluid mb-4 ld_item">
    <div class="row" id="display-logs">
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <?php $date = date('Y-m-d') ?>
        <h2 class="ld_itema">Logs du <?php echo $date ?></h2>
        ...
        <div id="logs-display" class="ld_itema">
        <?php if (is_file($_SERVER['DOCUMENT_ROOT'] . '/logs/date/' . $date . '.txt')) : ?>
