...
<head>
  ...
  <title>Dashboard | Evénements</title>
  ...
  <div class="container-fluid">
    ...
    $result = $req->fetch(PDO::FETCH_ASSOC);?>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 ld_item">
        <h2 class="ld_itema">Evénements (<?php echo $result['COUNT(name)'] ?>)</h2>
                  ...
                  <th scope="col" width="8%">Capacité</th>
                    ...
                    <th scope="col">
                      <div class=" hover-effect d-flex align-items-center">
                        ...
                        <a class="add-cta ld_itema" href="events?type=create">Ajouter un événement</a>     
                      </div>
                    </th>
