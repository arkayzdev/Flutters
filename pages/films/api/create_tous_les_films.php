...
if(isset($_GET['search']) && $_GET['search']!=""){
    $q = 'SELECT * FROM MOVIE WHERE title LIKE ? AND id_movie NOT IN(SELECT id_movie FROM TAKE_PLACE WHERE id_session IN (SELECT id_session FROM Flutters.SESSION WHERE seance_date >=(SELECT DATE(SYSDATE()) FROM dual)) ORDER BY release_date DESC) ORDER BY release_date DESC;';
