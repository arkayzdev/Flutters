<?php
    ...
    <page> 
        ...
        <p style="margin: 75px 0 0 100px; padding:0; font-size:18px;"> <strong>ID</strong>: #' . $_POST['user_id'] . ' </p>
        <p style="margin: 15px 0 0 100px; padding:0; font-size:18px;"> <strong>Utilisateur</strong>: ' . $_POST['last_name'] . ' ' . $_POST['first_name'] . '  </p>
        ...
        <img style="width:200px; height:auto; position: absolute; left:500px; top: 150px; object-fit: cover;" src="users_avatars/' . $_POST['avatar'] . '">
